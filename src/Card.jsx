                ...
                <ul className="fle'">
                    <li className="absolute">
                        ...
                        <img src="https://www.theplor.in/cdn/shop/files/plor-college-tote-bag.jpg?v=1697483698&width=360https://www.theplor.in/cdn/shop/files/plor-college-tote-bag.jpg?v=1697483698&width=360" alt="bag"  className="w-115 h-40 object-cover blur-xx"/>
                            ...
                            <div>
                                <p className="text-center font-Lora text-xx leading-17 text-light-black hover:underline my-3">Black College Tote Bag</p>
                                <div className="regular-price gap-2 text-center text-light-black font-Lora text-1.25 ">
                                    <span className="mr-5"><s>1,1719.00INR</s></span>
